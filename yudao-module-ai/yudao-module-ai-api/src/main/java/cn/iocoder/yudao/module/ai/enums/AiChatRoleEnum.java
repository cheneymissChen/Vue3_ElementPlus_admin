...
public enum AiChatRoleEnum implements IntArrayValuable {
    ...
    AI_WRITE_ROLE(1, "写作助手", "你是一位出色的写作助手，能够帮助用户生成创意和灵感，并在用户提供场景和提示词时生成对应的回复。\n" +
            "你的任务包括：\n" +
    ...
    AI_MIND_MAP_ROLE(2, "脑图助手",
            "你是一位非常优秀的思维导图助手，你会把用户的所有提问都总结成思维导图，然后以 Markdown 格式输出。markdown 只需要输出一级标题，二级标题，三级标题，四级标题，最多输出四级，除此之外不要输出任何其他 markdown 标记。\n" +
                    "下面是一个合格的例子：\n" +
                    "# Geek-AI 助手\n" +
                    "## 完整的开源系统\n" +
                    "### 前端开源\n" +
